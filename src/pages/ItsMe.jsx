		...
		<motion.div
			...
			<div className='justify-center flex flex-col gap-8 h-fit'>
				...
				<h1
					...
					languages like JavaScript , Java and Python. Building projects has got
					me hands-on experience with MERN (MongoDB, ExpressJS, ReactJS, NodeJS)
					tech stack trained me to become a more adaptive and collaborative
					professional. I also have been a Teacher for enough time now. Making
					things Simpler to understand has always been my thing. I am passionate
